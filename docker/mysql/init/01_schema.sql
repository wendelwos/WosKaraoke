-- Script de inicialização do banco de dados Docker
...
('superadmin', 'admin@karaokeshow.com', '$2y$10$kk2FiMF6vyfqJoDRVlvPb.eWGrZxw6Y.eaZriUq/GdOfrmcMo6twS', 'Super Administrador')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);

-- Admin padrão para testes (senha: admin123)
INSERT INTO `admins` (`username`, `email`, `password_hash`, `name`, `role`) VALUES
('admin', 'kj@karaokeshow.com', '$2y$10$kk2FiMF6vyfqJoDRVlvPb.eWGrZxw6Y.eaZriUq/GdOfrmcMo6twS', 'Administrador KJ', 'admin')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
...
('Karaoke Demo', 'demo', 'demo@karaokeshow.com', '$2y$10$bPw2VTSWp68htCpM0ow2juBUTT96PQG.q2wIj6Bb.gtoaBqtg4sQu', 'starter')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
